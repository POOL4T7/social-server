...
router.route("/followings").get(UserMiddleware.protect, UserController.getUserFollowings);
...
router.route("/:userId/like").patch(UserMiddleware.protect, UserController.addLike);
router.route("/:userId/dislike").patch(UserMiddleware.protect, UserController.removeLike);
